...
WHERE COURSE.Flag =1  AND User.ID='$ID'";
...
echo"<div>";
echo "<table class='course' border=1>" ;
echo"<tr><td colspan=3> <p class='course'>: الدورات الحالية</p>  </tr>";
echo"<tr>";
...
//the user did not take any course before	
    ...
    echo "<p class='course'> "."غير مسجل في دورة حاليا</p>";
                 }//end else
...
echo "<p class='course'> لا يمكن عرض الدورات الحالية</p>";;
 }
